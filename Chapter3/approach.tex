...
In this project, we propose the crowd monitoring framework for emergency management in mass gatherings. The objective of the framework is: 
\begin{inparaenum}[i)]
...
To achieve those objectives, as can be seen in Figure \ref{fig:frameworkOverview} the framework consists of three layer:
\begin{inparaenum}[i)]
...
The context data layer collects the data from 
...
There has been several works which are mentioned in the literature review on crowd modelling. Berlonghi's model is among the most widely adopted in emergency planning. 
